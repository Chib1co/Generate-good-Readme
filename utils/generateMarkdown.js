...
function generateMarkdown({userName, userEmail, userRepo, title, description, projectImgSRC, projectInstall, projectRun, projectTest, projectInfo, projectLicense}) {
